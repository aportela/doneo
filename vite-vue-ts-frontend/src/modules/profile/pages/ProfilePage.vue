<script setup lang="ts">
    ...
    import { NCard, NForm, NAvatar, NFlex, NFormItem, NInput, NButton, NButtonGroup, NPopover, NIcon, NGrid, NGridItem, NDivider, NTag, type FormInst, type FormRules, type FormItemRule } from 'naive-ui';
        ...
        <n-form ref="profileFormRef" :model="profile" :rules="state.ajaxRunning ? {} : profileFormRules"
            ...
            <n-flex align="center">
                ...
                <n-form-item label="New password"
                    :feedback="!validNewPassword ? 'min password length 4 chars' : undefined"
            ...
            <n-flex align="center">
                <div>
                    <h3>Theme</h3>
                    <n-button-group>
                        <n-button :disabled="userSettingsStore.lightTheme" @click="userSettingsStore.toggleTheme">
                            <template #icon>
                                <n-icon :component="IconSun" />
                            </template>
                            light
                        </n-button>
                        <n-button :disabled="userSettingsStore.darkTheme" @click="userSettingsStore.toggleTheme">
                            <template #icon>
                ...
                <div>
                    ...
                    <n-button-group>
                        ...
                        <n-input placeholder="mask preview (current datetime)"
                            v-model:value="currentDatetimeMaskPreview" readonly />
                    </n-button-group>
                </div>
                <div>
                    <h3>Notifications</h3>
