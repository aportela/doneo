      ...
      menus: {
        NavigationMenu: {
          items: {
            ...
            switchToLightTheme: "Light theme",
            switchToDarkTheme: "Dark theme",
            switchTopNavigation: "Top navigation",
      ...
      components: {
        RoleForm: {
          ...
          permissionSwitches: {
            ...
            updateTaskDenied: "UpdateTaskDenied",
            deleteTaskAllowed: "Delete task allowed",
            deleteTaskDenied: "Delete task denied",
            viewTaskAllowed: "View task allowed",
            viewTaskDenied: "View task denied",
          ...
          body: {
            columns: {
              operationType: {
                ...
                projectPermissionAdded: "Project permission added",
                projectPermissionDeleted: "Project permission deleted",
                projectPageAdded: "Project page added",
                projectPageUpdated: "Project page updated",
                projectPageDeleted: "Project page deleted",
                taskCreated: "Task created",
                taskUpdated: "Task updated",
                taskDeleted: "Task deleted",
                taskNoteAdded: "Task note added",
                ...
                taskTimeEntryUpdated: "Task time entry updated",
                taskTimeEntryDeleted: "Task time entry deleted",
                taskPageAdded: "Task page added",
                taskPageUpdated: "Task page updated",
                taskPageDeleted: "Task page deleted",
