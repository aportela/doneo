export default {
  ...
  searchByEmailDefaultPlaceholder: "procurar por email",
  ...
  "No users found": "No se atoparon usuarios",
  deleteUserConfirmation:
    'Está a punto de elimina-lo usuario "{name}" do sistema.',
  restoreUserConfirmation:
    'Está a punto de restaura-lo usuario "{name}" do sistema.',
  "There was a problem while refreshing the user list":
    "Producíuse un erro durante a procura de usuarios",
  "We couldn’t find the specified user": "O usuario especificado non existe",
  ...
  userFormNameFieldEmptyError: "O nome está vacío",
  userFormNameFieldTooLargeError: "O nome é moi longo",
  userFormNameFieldAlreadyExists: "O nome xa existe",
  userFormEmailFieldEmptyError: "O email está vacío",
  userFormEmailFieldInvalidError: "O email non ten un formato válido",
  userFormEmailFieldTooLargeError: "O email é moi longo",
  userFormEmailFieldAlreadyExists: "O email xa existe",
  ...
  RoleProjectPermissionsTableHeader: "Permisos de proxecto",
  RoleTasksPermissionsTableHeader: "Permisos de tarea",
  "Update project allowed": "Permitir modificar proxecto",
  "Delete project allowed": "Permitir eliminar proxecto",
  "View project allowed": "Permitir ver proxecto",
  "Add task allowed": "Permitir engadir tarea",
  "Update task allowed": "Permitir modificar tarea",
  "Delete task allowed": "Permitir eliminar tarea",
  "View task allowed": "Permitir ver tarea",
  ...
  "Project permissions": "Permisos do proxecto",
  "Task permissions": "Permisos da tarea",
  ...
  "There was a problem while loading the role data":
    "Producíuse un erro ó carga-lo rol",
  ...
  TotalProjectTypesPagerLabel: "Total tipos de proxecto: {total}",
  ProjectTypeNameTableHeader: "Nome",
  ...
  "All results": "Tódo-los resultados",
  labelSelectorResultsPage: "{number} resultados/páxina",
};
